...
export default function Home() {
  ...
  return (
    <div className="xl:overflow-hidden xl:px-0 xl:flex xl:items-center xl:flex-col xl:grid-rows-none xl:grid-cols-none xl:h-max xl:gap-0 px-4 h-screen grid gap-4 grid-cols-1 grid-rows-2">
